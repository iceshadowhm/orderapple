package com.example.nanohttppd;
		...
		if (res == null && f.isDirectory()) {
			...
			if (res == null) {
				...
				// No index file, list the directory if it is readable
					...
					String[] files = f.list();
					String msg = "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><title>文件服务</title></head><body><h1>Directory "
							+ uri + "</h1><br/>";
